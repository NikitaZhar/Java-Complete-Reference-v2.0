...
Более подробно про литералы см. [[3.10 Literals (OK)]]
...
**Поля классов**, **поля экземпляров** и **компоненты массивов** автоматически получают **значения по умолчанию**. **Локальные переменные** и **параметры методов** значений по умолчанию не получают и должны быть **definite assigned** перед использованием.
Точные правила инициализации, значения по умолчанию, а также ограничения на использование **неопределённо инициализированных** локальных переменных определены в 4.11–4.12.
