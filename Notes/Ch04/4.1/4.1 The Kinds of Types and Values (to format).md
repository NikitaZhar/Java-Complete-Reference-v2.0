...
## [[4.1.0 Overview — Общий обзор видов типов и значений (ok)]]
## [[4.1.1 Definition of Type — Определение типа (ok)]]
...
## [[4.1.7 Runtime Representation of Values — Представление значений во время выполнения]]
